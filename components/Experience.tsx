...
const experiences = [
  {
    ...
    period: 'Present',
    description: 'Pursuing advanced studies in Computer Science with focus on AI Safety, Machine Learning, and Deep Learning.',
  ...
  },
  {
    ...
    period: 'Present',
    description: 'Serving on the student advisory board to represent student voices to faculty and leadership. Collaborating on initiatives that improve curriculum, student experience, and community engagement across Khoury.',
  ...
  },
  {
    ...
    period: 'Present',
    description: 'Active member in the Southeast (Region 7), participating in professional development events, workshops, and networking opportunities to empower the Hispanic community in STEM.',
  ...
  },
  {
    ...
    period: 'Present',
    description: 'Researching AI safety, alignment, and making AI systems more reliable and aligned with human values.',
            ...
            return (
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${exp.color} 
        ...
        <div className="mt-16 text-center">
          <div className="inline-block glass-card p-6 rounded-xl">
            <p className="text-lg text-gray-300">
              Open to <span className="text-primary-400 font-semibold">internships</span> and 
              <span className="text-primary-400 font-semibold"> opportunities</span> in Software Engineering, 
